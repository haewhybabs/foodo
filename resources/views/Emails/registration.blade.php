...
<head>
	...
	<title>Foodxyme Registration Email</title>
	<style type="text/css">
							...
							<tr>
								...
								<td width="200" valign="top" align="center">
									<div class="contentEditableContainer contentImageEditable">
										...
										<img src="{{asset('_email/images/foodxyme1.png')}}" width="250px" height="50px"  alt='Logo'  data-default="placeholder" />
					                	</div>
					              	</div>
								</td>
								<td width="200" valign="top">&nbsp;</td>
								...
								<td width="400" align="center">
									<div class="contentEditableContainer contentTextEditable">
					                	<div class="contentEditable" align='left' >
					                  		<p> <strong>Hi {{$user['name']}},</strong> 
					                  			<br/>
												<br/>
												  Thanks for getting started with FoodXyme. We are so glad to have you on board.
												<br/>
												FoodXyme is an online food delivery system that allows you to place an order for
												your desired food from your desired restaurant and get it delivered to your door step.<br>							
												<br/>
												<br/>
						...
						<table cellpadding="0" cellspacing="0" border="0" align="center" width="600" class="container">
							...
							<tr>
								<td width="60%" height="70" valign="middle" style="padding-bottom:20px;">
									<div class="contentEditableContainer contentTextEditable">
					                	<div class="contentEditable" align='left' >
					                  		<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Sent to {{$user['email']}} by FoodXyme</span>
											<br/>
											<span style="font-size:11px;color:#555;font-family:Helvetica, Arial, sans-serif;line-height:200%;">African Centre of Excellence Project OAU ICT-Driven Knowledge Park |+234 81 3537 3563</span>
											<br/>
										...
										<tr>
											...
											{{-- <td valign="top" width='34'>
												<div class="contentEditableContainer contentFacebookEditable" style='display:inline;'>
													...
													<img src="{{asset('_email/images/facebook.png')}}" data-default="placeholder" data-max-width='30' data-customIcon="true" width='30' height='30' alt='facebook' style='margin-right:40x;'>
							                        </div>
							                    </div>
											</td> --}}
											<td valign="top" width='34'>
												<div class="contentEditableContainer contentTwitterEditable" style='display:inline;'>
							                      <div class="contentEditable" >
														<a target='_blank' href="https://twitter.com/foodxyme" data-default="placeholder"  style="text-decoration:none;">
												 		 	<img src="{{asset('_email/images/twitter.png')}}" data-default="placeholder" data-max-width='30' data-customIcon="true" width='30' height='30' alt='twitter' style='margin-right:40x;'>
														</a>
													</div>
							                    </div>
											</td>
												...
												<div class="contentEditableContainer contentImageEditable" style='display:inline;'>
							                      <div class="contentEditable" >
							                        <a target='_blank' href="https://instagram.com/foodxymeng" data-default="placeholder"  style="text-decoration:none;">
														<img src="{{asset('_email/images/instagram.png')}}" width="30" height="30" data-max-width="30" alt='pinterest' style='margin-right:40x;' />
													</a>
							                      </div>
							                    </div>
											</td>
