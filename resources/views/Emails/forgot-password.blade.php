								...
								<td width="400" align="center">
									<div class="contentEditableContainer contentTextEditable">
					                	<div class="contentEditable" align='left' >
					                  		<p> <strong>Hi {{$user_details->name}},</strong> 
					                  			<br/>
												<br/>
												  You recently requested to reset your password for your foodxyme account.
                                                <br/>
                                                Kindly click the button below to reset it.
												<br/>
												<br/>
											</p>
					                	</div>
									...
									<table cellpadding="0" cellspacing="0" border="0" align="center" width="200" height="50">
										<tr>
											<td bgcolor="#ED006F" align="center" style="border-radius:4px;" width="200" height="50">
												<div class="contentEditableContainer contentTextEditable">
								                	<div class="contentEditable" align='center' >
                                                    <a target='_blank' href="{{URL::TO('reset-password')}}/{{$user_details->password}}" class='link2'>Reset Password</a>
								                	</div>
								              	</div>
											</td>
										</tr>
						...
						<table cellpadding="0" cellspacing="0" border="0" align="center" width="600" class="container">
							...
							<tr>
								<td width="60%" height="70" valign="middle" style="padding-bottom:20px;">
									<div class="contentEditableContainer contentTextEditable">
					                	<div class="contentEditable" align='left' >
					                  		<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Sent to {{$user_details->email}} by FodXyme</span>
											<br/>
